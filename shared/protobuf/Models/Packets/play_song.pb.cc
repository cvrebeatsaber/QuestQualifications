...
struct PlaySongDefaultTypeInternal {
  constexpr PlaySongDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~PlaySongDefaultTypeInternal() {}
  union {
    PlaySong _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PlaySongDefaultTypeInternal _PlaySong_default_instance_;
}  // namespace Packets
}  // namespace Models
}  // namespace TournamentAssistantShared
...
const char descriptor_table_protodef_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ble_pause\030\004 \001(\010\022%\n\035disable_scoresaber_su"
  "bmission\030\006 \001(\010\022#\n\033show_normal_notes_on_s"
  "tream\030\007 \001(\010B+\252\002(TournamentAssistantShare"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto = {
  false, false, 424, descriptor_table_protodef_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto, "protobuf/Models/Packets/play_song.proto", 
  &descriptor_table_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto_once, descriptor_table_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto::offsets,
  file_level_metadata_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto, file_level_enum_descriptors_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto, file_level_service_descriptors_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto);
  return descriptor_table_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto(&descriptor_table_protobuf_2fModels_2fPackets_2fplay_5fsong_2eproto);
namespace TournamentAssistantShared {
namespace Models {
namespace Packets {
