...
namespace Models {
namespace Packets {
constexpr SongFinished::SongFinished(
...
struct SongFinishedDefaultTypeInternal {
  constexpr SongFinishedDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~SongFinishedDefaultTypeInternal() {}
  union {
    SongFinished _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SongFinishedDefaultTypeInternal _SongFinished_default_instance_;
}  // namespace Packets
}  // namespace Models
}  // namespace TournamentAssistantShared
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto = {
  false, false, 486, descriptor_table_protodef_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto, "protobuf/Models/Packets/song_finished.proto", 
  &descriptor_table_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto_once, descriptor_table_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto_deps, 2, 1,
  schemas, file_default_instances, TableStruct_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto::offsets,
  file_level_metadata_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto, file_level_enum_descriptors_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto, file_level_service_descriptors_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto);
  return descriptor_table_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto(&descriptor_table_protobuf_2fModels_2fPackets_2fsong_5ffinished_2eproto);
namespace TournamentAssistantShared {
namespace Models {
namespace Packets {
