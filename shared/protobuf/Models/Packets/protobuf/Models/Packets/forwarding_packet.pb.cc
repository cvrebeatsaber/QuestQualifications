...
namespace Models {
namespace Packets {
class ForwardingPacketDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ForwardingPacket> _instance;
} _ForwardingPacket_default_instance_;
}  // namespace Packets
}  // namespace Models
}  // namespace TournamentAssistantShared
static void InitDefaultsscc_info_ForwardingPacket_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::TournamentAssistantShared::Models::Packets::_ForwardingPacket_default_instance_;
    new (ptr) ::TournamentAssistantShared::Models::Packets::ForwardingPacket();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_ForwardingPacket_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_ForwardingPacket_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto_sccs[1] = {
  &scc_info_ForwardingPacket_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto = {
  false, false, descriptor_table_protodef_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto, "protobuf/Models/Packets/forwarding_packet.proto", 354,
  &descriptor_table_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto_once, descriptor_table_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto_sccs, descriptor_table_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto_deps, 1, 2,
  schemas, file_default_instances, TableStruct_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto::offsets,
  file_level_metadata_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto, 1, file_level_enum_descriptors_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto, file_level_service_descriptors_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto)), true);
namespace TournamentAssistantShared {
namespace Models {
namespace Packets {
...
void ForwardingPacket::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ForwardingPacket_protobuf_2fModels_2fPackets_2fforwarding_5fpacket_2eproto.base);
