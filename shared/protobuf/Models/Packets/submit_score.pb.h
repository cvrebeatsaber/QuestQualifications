...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protobuf_2fModels_2fPackets_2fsubmit_5fscore_2eproto_metadata_getter(int index);
...
class SubmitScore PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~SubmitScore();
  explicit constexpr SubmitScore(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_protobuf_2fModels_2fPackets_2fsubmit_5fscore_2eproto_metadata_getter(kIndexInFileMessages);
  }
