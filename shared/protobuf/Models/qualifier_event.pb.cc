...
namespace Models {
constexpr QualifierEvent::QualifierEvent(
...
struct QualifierEventDefaultTypeInternal {
  constexpr QualifierEventDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~QualifierEventDefaultTypeInternal() {}
  union {
    QualifierEvent _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT QualifierEventDefaultTypeInternal _QualifierEvent_default_instance_;
}  // namespace Models
}  // namespace TournamentAssistantShared
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_protobuf_2fModels_2fqualifier_5fevent_2eproto = {
  false, false, 642, descriptor_table_protodef_protobuf_2fModels_2fqualifier_5fevent_2eproto, "protobuf/Models/qualifier_event.proto", 
  &descriptor_table_protobuf_2fModels_2fqualifier_5fevent_2eproto_once, descriptor_table_protobuf_2fModels_2fqualifier_5fevent_2eproto_deps, 3, 1,
  schemas, file_default_instances, TableStruct_protobuf_2fModels_2fqualifier_5fevent_2eproto::offsets,
  file_level_metadata_protobuf_2fModels_2fqualifier_5fevent_2eproto, file_level_enum_descriptors_protobuf_2fModels_2fqualifier_5fevent_2eproto, file_level_service_descriptors_protobuf_2fModels_2fqualifier_5fevent_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_protobuf_2fModels_2fqualifier_5fevent_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_protobuf_2fModels_2fqualifier_5fevent_2eproto);
  return descriptor_table_protobuf_2fModels_2fqualifier_5fevent_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_protobuf_2fModels_2fqualifier_5fevent_2eproto(&descriptor_table_protobuf_2fModels_2fqualifier_5fevent_2eproto);
namespace TournamentAssistantShared {
namespace Models {
