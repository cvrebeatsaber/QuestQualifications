...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protobuf_2fModels_2fcharacteristic_2eproto_metadata_getter(int index);
...
class Characteristic PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr Characteristic(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_protobuf_2fModels_2fcharacteristic_2eproto_metadata_getter(kIndexInFileMessages);
  }
